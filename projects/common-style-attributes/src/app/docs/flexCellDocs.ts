  ...
  attributes: [
    {
      name: 'flex-cell',
      description: `<div>
    An implementation of Google Material Design's <a
        href="https://material.io/design/layout/responsive-layout-grid.html#columns-gutters-and-margins">responsive
    layout grid</a>. This hybrid grid system
    uses easy to understand attributes to layout content.
    <ul>
        ...
        <li>Strictly speaking, this is a flow layout rather than grid layout.
            ...
            maximum width of the layout's container, it automatically wraps cells to the next row.
        </li>
        <li>Active "mode" is based on the layout's width. 0 to 479px is phone mode; 480px to 839px is tablet mode; 840px
            and up is desktop mode.
        </li>
    </ul>`
    },
    {
